...
const { getAllUsers, getContact, getAllUserEnquiry, postInfo, postLink, getUserById, deleteUserById, updateUserById, deleteContactById, deleteEnquiryById, getEnquiryById} = require("../controllers/admin-controller");
...
router.post("/postLink", fetchUser, fetchadmin, postLink);
